return {
    ...
    ["mcm.inspection.inventory.label"] = "Mouse Over an Item in Inventory",
    ["mcm.inspection.inventory.description"] = "When you mouse over an item in your inventory, you can inspect it.",
    ["mcm.inspection.barter.label"] = "Mouse Over an Item in Barter",
    ["mcm.inspection.barter.description"] = "When you mouse over an item being bartered, you can inspect it.",
    ["mcm.inspection.contents.label"] = "Mouse Over an Item in Container",
    ["mcm.inspection.contents.description"] = "When you mouse over an item in a container or pickpocketing, you can inspect it.",
    ["mcm.inspection.activatable.label"] = "Look at an Activatable Object",
    ["mcm.inspection.activatable.description"] = "When you are looking at an activatable object, you can inspect it.",
