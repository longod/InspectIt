return {
    ...
    ["mcm.display.leftPart.description"] = "Mirrors the left part. Most of the left part is the same as the right part, so the left hand is the right hand.\nExclusion settings for each item or plugin can be configured from '%{name}' tab.",
    ...
    ["mcm.development.experimental.description"] = "Enable experimental features. Glitches may occur.\nIn addition to activatable objects, most other objects can be inspected.",
